...
-- + -------------- + --------------- + -------------- + ------------ +
-- | Shah Arfin     | 205             | 2023-06-28     | 2023-07-02   |
...
-- | Shah Arfin     | 307             | 2023-03-17     | 2023-03-20   |
-- + -------------- + --------------- + -------------- + ------------ +
...
INNER JOIN Room r 
ON rr.RoomNumber = r.RoomNumber
WHERE GuestName LIKE 'Shah Arfin';

-- + -------------- + --------------- + -------------- + ------------------- + ----------------- +
-- | GuestName      | RoomNumber      | StartDate      | NumberOfAdults      | NumberOfKids      |
-- + -------------- + --------------- + -------------- + ------------------- + ----------------- +
-- | Shah Arfin     | 307             | 2023-03-17     | 1                   | 1                 |
-- | Shah Arfin     | 205             | 2023-06-28     | 2                   | 0                 |
-- + -------------- + --------------- + -------------- + ------------------- + ----------------- +
...
SELECT  GuestName, 
        ...
        Phone 
FROM    Guest
WHERE   Phone = '5183646672';

-- + -------------- + ------------ + ---------- +
-- | GuestName      | Address      | Phone      |
-- + -------------- + ------------ + ---------- +
-- | Shah Arfin     | 5506 39th Ave, apt 4 | 5183646672 |
-- | Shah Arfin     | 5506 39th Ave, apt 4 | 5183646672 |
-- + -------------- + ------------ + ---------- +