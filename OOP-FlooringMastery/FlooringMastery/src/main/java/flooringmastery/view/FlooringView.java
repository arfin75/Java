...
public class FlooringView {
    ...
    public boolean displayOrderToEdit(Order updatedOrder) {
        ...
        boolean keepAsking = true;
        while (keepAsking) {
            String userAnswer = io.readString("Do you want to save the changes? (type y/n)");
    ...
    public Order getOrderInformation() {
        ...
        String stateAbb = io.readString("Please select your state from above: ").toUpperCase();
        String product = io.readString("Please select your product type from above: ");
    ...
    public void displayProducts(List<Product> products) {
        io.print("\n");
        io.print("Available products type: \n");
    ...
    public Order getUpdatedInformation(Order originalOrder) {
        ...
        String newStateAbb = io.readString("Please type new state name: ").toUpperCase();
